              ...
              <PopoverContent className="p-1 bg-surface-200-800 rounded-xl w-80 transition-all duration-300 ease-in-out">
                ...
                <PopoverDescription >
                  <div className="p-0 gap-1 flex flex-col 0">
                    <button className="flex flex-row gap-3 rounded-lg  p-3 bg-surface-50-950 items-center pr-6 ease-in-out duration-200"  onClick={() => {
                                setOpen(false);
                                setProfileOpen(true);
                              }}>
                      <Avatar
                   ...
                   <div className="flex flex-col gap-0 flex-1 overflow-hidden">
                      <p className="font-medium text-left text-base truncate">{user.name}</p>
