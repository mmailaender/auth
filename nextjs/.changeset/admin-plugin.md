...
Preserve the current page after embedded social, magic-link, and verification sign-in flows without introducing a same-page navigation after password or OTP sign-in.
