import { V as store_get, W as ensure_array_like, X as attr, Y as unsubscribe_stores, S as pop, P as push, Z as head, _ as stringify, $ as spread_attributes, a0 as bind_props, a1 as rest_props, a2 as fallback, a3 as clsx, a4 as element, a5 as slot, a6 as sanitize_props, a7 as spread_props, T as escape_html, a8 as copy_payload, a9 as assign_payload } from "../../chunks/index.js";
...
import { s as setParaglideContext, g as getTranslationFunctions } from "../../chunks/index5.js";
import { m as mergeProps$1, t as toStyleString, g as getDocument, a as getWindow$1, b as addDomEvent, r as raf$1, f as fireCustomEvent, i as isFocusable$1, c as getEventTarget, d as callAll, e as isHTMLElement$1, h as contains, j as getNearestOverflowAncestor$1, k as isContextMenuEvent, n as noop, l as isNull, o as runIfFn, p as compact, q as isFunction, w as warn, s as waitForElements, u as setStyle, v as isIos, x as createAnatomy, y as createScope, z as getFocusables, A as isSafari, B as dataAttr, C as createMachine, D as proxyTabFocus, E as getInitialFocus, F as createProps, G as useMachine, H as snapshot, I as useId, J as normalizeProps, K as Avatar } from "../../chunks/Popover.svelte_svelte_type_style_lang.js";
import { p as page$1 } from "../../chunks/index6.js";
import "fauna";
    ...
    },
    {
      ...
      actions: {
        ...
        setFinalFocus(ctx2, evt) {
          ...
          raf$1(() => {
            const element2 = dom.getTriggerEl(ctx2);
            element2?.focus({ preventScroll: true });
          });
        },
        invokeOnOpen(ctx2) {
...
function Popover($$payload, $$props) {
  ...
  const [snapshot$1, send] = useMachine(
    machine({
      id: useId(),
      open,
  ...
  const api = connect(snapshot$1, send, normalizeProps);
  ...
  $$payload.out += `<span${attr("class", `${stringify(base2)} ${stringify(classes)}`)} data-testid="popover"><button${spread_attributes(
    {
      ...paraglide_sveltekit_translate_attribute_pass_handle_attributes(
        {
          ...triggerProps,
  ...
  trigger?.($$payload);
  $$payload.out += `<!----></button> <div${spread_attributes(
    {
      ...api.getPositionerProps(),
      class: `${stringify(positionerBase)} ${stringify(positionerZIndex)} ${stringify(positionerClasses)}`
    },
    { "svelte-jxlqiw": true }
  )}>`;
  if (api.open) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div${spread_attributes({ ...api.getContentProps() }, { "svelte-jxlqiw": true })}>`;
    if (arrow2) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<div${spread_attributes({ ...api.getArrowProps() }, { "svelte-jxlqiw": true })}><div${spread_attributes(
        {
    ...
    $$payload.out += `<!--]--> <div${attr("class", `${stringify(contentBase)} ${stringify(contentBackground)} ${stringify(contentClasses)}`)}>`;
    content?.($$payload);
    $$payload.out += `<!----></div></div>`;
  } else {
    $$payload.out += "<!--[!-->";
...
function SignOutButton($$payload, $$props) {
  push();
  let {
    redirectUrl,
  ...
  $$payload.out += `<button${attr("class", clsx(className))}>`;
  if (children) {
    $$payload.out += "<!--[-->";
    children($$payload);
    $$payload.out += `<!---->`;
    ...
    $$payload.out += "<!--[!-->";
    $$payload.out += `${escape_html(buttonText)}`;
  }
  $$payload.out += `<!--]--></button>`;
  pop();
}
function UserButton($$payload, $$props) {
  push();
  let user = page$1.data.user ? JSON.parse(page$1.data.user) : null;
  const userAccounts = [
    {
      firstName: "Cameron",
      lastName: "Walker",
    ...
    if (user) {
      $$payload2.out += "<!--[-->";
      {
        let trigger = function($$payload3) {
          ...
          const each_array = ensure_array_like(userAccounts);
          $$payload3.out += `<ul role="list" class="space-y-1"><li><div class="flex gap-x-3 rounded-md p-4 text-sm/6 font-semibold text-surface-700-300">`;
          Avatar($$payload3, {
            src: user.avatar,
            name: user.firstName + " " + user.lastName,
            size: "size-10"
          });
          $$payload3.out += `<!----> <div class="flex flex-col gap-3"><div class="flex-1"><p class="font-medium">${escape_html(user.firstName + " " + user.lastName)}</p> <p class="text-sm">${escape_html(user.primaryEmail)}</p></div> <div class="flex space-x-2"><button class="btn preset-outlined-surface-500">Manage account</button> `;
          SignOutButton($$payload3, { class: "btn preset-outlined-surface-500" });
          $$payload3.out += `<!----></div></div></div></li> <!--[-->`;
          for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
            let account = each_array[$$index];
            $$payload3.out += `<li><a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`#`, void 0))} class="group flex gap-x-3 rounded-md p-4 text-sm/6 font-semibold text-surface-700-300 hover:bg-gray-50 hover:text-primary-600-400">`;
            Avatar($$payload3, {
              src: account.avatar,
              name: account.firstName + " " + account.lastName,
              size: "size-10"
            });
            $$payload3.out += `<!----> <div class="flex flex-col gap-3"><div class="flex-1"><p class="font-medium">${escape_html(account.firstName + " " + account.lastName)}</p> <p class="text-sm">${escape_html(account.email)}</p></div></div></a></li>`;
          }
          $$payload3.out += `<!--]--> <a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`/sign-in`, void 0))} class="flex items-center gap-x-5 rounded-md p-4 pl-6 text-sm/6 font-semibold text-surface-700-300 hover:bg-gray-50 hover:text-primary-600-400">`;
          Plus($$payload3, {
            class: "rounded-full bg-surface-700-300 text-surface-300-700"
          });
          $$payload3.out += `<!----> Add account</a> `;
          if (userAccounts.length > 1) {
            $$payload3.out += "<!--[-->";
            $$payload3.out += `<button class="flex w-full items-center gap-x-6 rounded-md p-4 pl-7 text-sm/6 font-semibold text-surface-700-300 hover:bg-gray-50 hover:text-primary-600-400">`;
            Log_out($$payload3, { class: "size-4" });
            $$payload3.out += `<!----> Sign out from all accounts</button>`;
          } else {
            $$payload3.out += "<!--[!-->";
          }
          $$payload3.out += `<!--]--></ul>`;
      ...
      $$payload2.out += "<!--[!-->";
      $$payload2.out += `<a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`/sign-in`, void 0))} class="btn preset-filled-primary-500">Sign in</a>`;
    }
    $$payload2.out += `<!--]-->`;
  }
  do {
...
function Navbar($$payload, $$props) {
  ...
  $$payload.out += `<nav class="bg-gray-800"><div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8"><div class="relative flex h-16 items-center justify-between"><div class="absolute inset-y-0 left-0 flex items-center sm:hidden"><button type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false"><span class="absolute -inset-0.5"></span> <span class="sr-only">Open main menu</span> <svg class="block size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path></svg> <svg class="hidden size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"></path></svg></button></div> <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start"><div class="flex shrink-0 items-center"><img class="h-8 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&amp;shade=500" alt="Your Company"></div> <div class="hidden sm:ml-6 sm:block"><div class="flex space-x-4"><a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`#`, void 0))} class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Dashboard</a> <a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`#`, void 0))} class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Team</a></div></div></div> <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0"><button type="button" class="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"><span class="absolute -inset-1.5"></span> <span class="sr-only">View notifications</span> <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0"></path></svg></button> <div class="relative ml-3">`;
  UserButton($$payload);
  $$payload.out += `<!----></div></div></div></div> <div class="sm:hidden" id="mobile-menu"><div class="space-y-1 px-2 pb-3 pt-2"><a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`#`, void 0))} class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Dashboard</a> <a${attr("href", paraglide_sveltekit_translate_attribute_pass_translateAttribute(`#`, void 0))} class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Team</a></div></div></nav>`;
  pop();
}
